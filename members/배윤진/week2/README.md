...
| 파일 | 형식 | 읽음 | 실행 |
| --- | --- | :--: | :--: |
| [`plot-quantum-states.ipynb`](A_docs/plot-quantum-states.ipynb) | notebook | [ ] | [ ] |
| [`visualize-circuits.ipynb`](A_docs/visualize-circuits.ipynb) | notebook | [ ] | [ ] |
| [`visualize-results.ipynb`](A_docs/visualize-results.ipynb) | notebook | [ ] | [ ] |

## B. 기출 문제 ([`B_practice/`](B_practice/))

Advocate practice exam 4종에서 이 토픽 문항만 추린 것 — [**17문항**](B_practice/questions.md) (algovista 2, clausia 6, MarcoBarroca 5, Q-Bees 4).
